...
def objective(trial,dirname):
    ...
    for i in range(n_samples):
        ...
        sample_fidelity = np.max(evolution)
        max_fidelity = max(max_fidelity, sample_fidelity)

        # Report intermediate results to Optuna
        trial.report(max_fidelity, i)
        ...
        row = {
            ...
            "trial_index": ti,
            "sample_index": i,
            "max_fidelity": format(sample_fidelity),
    ...
    #return 0.1*mean_fitness+mean_max_fidelity**2
